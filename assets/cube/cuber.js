	...
	*/
    ...
    THREE.CSS3DRenderer = function () {
        ...
        this.render = function (scene, camera) {
            ...
            var cubeStateEl = document.getElementById("cube-state");
            if (cubeStateEl) cubeStateEl.innerHTML = cube.state.string;
            // }
        };
    };
	...
	*/
    ...
    ERNO.extend(ERNO.Cube.prototype, {
        ...
        solve: function () {
            ...
            const input = document.getElementById("actionAlgorithm");

            if (input.value) {
                translateTwist(input.value);
